...
export default class AddAddressB extends Component {
  ...
  render() {
    const { addressType, numberFocused, streetFocused, districtFocused, zipFocused, cityFocused, modalVisible } = this.state;
        ...
        <KeyboardAwareScrollView contentContainerStyle={styles.contentContainerStyle}>
          <View style={styles.row}>
            <View style={styles.picker}>
              <View style={[styles.touchArea, addressType == "apartment" && { backgroundColor: Colors.primaryColor }]}>
                <TouchableItem onPress={this.setAddressType("apartment")}>
                  <View style={styles.iconContainer}>
                    <Icon name={APARTMAN_ICON} size={19} color={addressType == "apartment" ? Colors.onPrimaryColor : ICON_COLOR} />
                  </View>
                </TouchableItem>
              </View>
            ...
            <View style={styles.picker}>
              <View style={[styles.touchArea, addressType == "office" && { backgroundColor: Colors.primaryColor }]}>
                <TouchableItem onPress={this.setAddressType("office")}>
                  <View style={styles.iconContainer}>
                    <Icon name={OFFICE_ICON} size={19} color={addressType == "office" ? Colors.onPrimaryColor : ICON_COLOR} />
                  </View>
                </TouchableItem>
              </View>

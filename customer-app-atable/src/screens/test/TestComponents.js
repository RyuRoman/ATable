    ...
    return (
      <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <Caption style={styles.title}>{'<Avatar size="large" rounded />'}</Caption>
          ...
          <Avatar imageUri={ require('../../assets/img/profile_1.jpeg') } borderRadius={8} size="large" />

          <Caption style={styles.title}>
            {'<Avatar imageUri="http://..." rounded size={88} />'}
          </Caption>
          <Avatar imageUri={ require('../../assets/img/profile_1.jpeg') } rounded size={88} />

          {/* BottomSheet */}
          <Heading5 style={styles.pt32}>Bottom Sheet</Heading5>
          <Caption style={styles.title}>
          ...
          {/* Buttons */}
          <Heading5 style={styles.pt32}>Buttons</Heading5>
          <Caption style={styles.title}>{'<Button />'}</Caption>
          <Button />

          <Caption style={styles.title}>{'<Button outlined borderRadius={4} />'}</Caption>
          ...
          <Caption style={styles.title}>{'<Button rounded outlined />'}</Caption>
          ...
          <Caption style={styles.title}>{'<Button small borderRadius={4} />'}</Caption>
          <Button small borderRadius={4} />

          <Caption style={styles.title}>{'<Button small rounded />'}</Caption>
          <Button small rounded />

          <Caption style={styles.title}>{'<Button small rounded outlined />'}</Caption>
          <Button small rounded outlined />

          <Heading5 style={styles.pt32}>ContainedButton</Heading5>
          <Caption style={styles.title}>
            {
          ...
          <Heading5 style={styles.pt32}>LinkButton</Heading5>
          <Caption style={styles.title}>
          ...
          {/* Cards */}
          <Heading5 style={styles.pt32}>Cards</Heading5>
          ...
          <Caption style={styles.title}>{'<ActionProductCardHorizontal />'}</Caption>
          ...
          {/* Credit Card */}
          <Heading5 style={styles.pt32}>Credit Card</Heading5>
          <Caption style={styles.title}>
          ...
          {/* Divider */}
          <Heading5 style={styles.pt32}>Divider</Heading5>
          ...
          <Caption style={styles.title}>{'<Divider type="inset" marginLeft={48} />'}</Caption>
          <Divider type="inset" marginLeft={48} />

          {/* GradientContainer */}
          <Heading5 style={styles.pt32}>Gradient Container</Heading5>
          <Caption style={styles.title}>
          ...
          {/* Keyboard */}
          <Heading5 style={styles.pt32}>Numeric Keyboard</Heading5>
          <Caption style={styles.title}>{'<NumericKeyboard actionButtonTitle="Skip" />'}</Caption>
          <NumericKeyboard actionButtonTitle="Skip" />

          {/* List Item */}
          <Heading5 style={styles.pt32}>ListItem</Heading5>

          {/* Logo */}
          <Heading5 style={styles.pt32}>Logo</Heading5>
          <Caption style={styles.title}>{'<Logo tintColor="orange" />'}</Caption>
          <Logo tintColor="orange" />

          <Caption style={styles.title}>{'<Logo tintColor="red" size="large" />'}</Caption>
          ...
          {/* Modals */}
          <Heading5 style={styles.pt32}>Modals</Heading5>
          <Caption style={styles.title}>
          ...
          <Button onPress={this.showActivityIndicatorModal} title="Show ActivityIndicatorModal" />
          ...
          {/* Navigation */}
          <Heading5 style={styles.pt32}>Navigation</Heading5>
          <Caption style={styles.title}>
            {'<Header showBackButton tintColor="#000" title="Header" titleColor="#000" />'}
          </Caption>
          <Header showBackButton tintColor="#000" title="Header" titleColor="#000" />

          <Caption style={styles.title}>
            {'<Header showCloseButton tintColor="#000" title="Header" titleColor="#000" />'}
          </Caption>
          <Header showCloseButton tintColor="#000" title="Header" titleColor="#000" />

          {/* StarRating */}
          <Heading5 style={styles.pt32}>Star Rating</Heading5>
          ...
          {/* Typography */}
          <Heading5 style={styles.pt32}>Typography</Heading5>
          ...
          <Caption style={styles.title}>{'<Subtitle1>Text.</Subtitle1>'}</Caption>
          <Subtitle1>Text.</Subtitle1>

          <Caption style={styles.title}>{'<Subtitle2>Text.</Subtitle2>'}</Caption>
          <Subtitle2>Text.</Subtitle2>

          <Caption style={styles.title}>{'<Text>Text.</Text>'}</Caption>
          <Text>Text.</Text>

          <Caption style={styles.title}>{'<Paragraph>Text.</Paragraph>'}</Caption>
          <Paragraph>Text.</Paragraph>

          {/* TextInput */}
          <Heading5 style={styles.pt32}>Text Input</Heading5>
          <Caption style={styles.title}>{'<UnderlineTextInput />'}</Caption>
          <UnderlineTextInput />

          <Caption style={styles.title}>{'<UnderlineTextInput borderColor="blue" />'}</Caption>
        ...
        >
          <View style={styles.bottomSheetContainer}>
            <Caption style={styles.title}>Any child Component can go here</Caption>
          </View>
        </BottomSheet>
